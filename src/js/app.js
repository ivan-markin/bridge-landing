...
document.querySelectorAll(".examples__tabs-item").forEach((el, i) => {
  el.addEventListener("click", (e) => {
    ...
    if (previousSiblingEl) {
      ...
      previousSiblingEl.querySelector(
        ".examples__tabs-item-header"
      ).style.height = "123px";
    }
...
window.addEventListener("scroll", () => {
  ...
  if (container) {
    ...
    if (
      scrollY > container.offsetTop &&
      scrollY < container.offsetTop + container.offsetHeight
    ) {
      images.forEach((img) => {
